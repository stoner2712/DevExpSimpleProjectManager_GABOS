...
namespace DevExpSimpleProjectManager.Module.BusinessObjects.Planning
{
    [RuleCriteria("EndDate >= StartDate", CustomMessageTemplate = "Start Date must be less than End Date")]
