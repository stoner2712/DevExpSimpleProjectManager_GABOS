...
using DevExpSimpleProjectManager.Module.BusinessObjects.Marketing;
using DevExpSimpleProjectManager.Module.BusinessObjects.Searching;

namespace DevExpSimpleProjectManager.Module.DatabaseUpdate;
    ...
    public override void UpdateDatabaseAfterUpdateSchema()
    {
        ...
        if (ObjectSpace.CanInstantiate(typeof(Customer)))
        {
            ...
            if (customer == null)
            {
                ...
                customer.Company = "Easter Connection";
            }
        }
